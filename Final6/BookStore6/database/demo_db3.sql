  ...
  --
  -- Host: 127.0.0.1
  -- Generation Time: May 08, 2023 at 05:47 AM
  ...
  INSERT INTO `users` (`id`, `name`, `username`, `password`, `age`, `gender`, `usertype`) VALUES
  (8, 'Harold Zamora', 'harold', '123', 69, 'Male', 'user'),
  (9, 'admin', 'admin', 'admin', 0, '', 'admin');
